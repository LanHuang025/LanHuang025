window.onload = async function () {
  ...
  search_one_btn.onclick = async function () {
    ...
    body += '<tr><td>' + hero_name + '</td><td>' + power_data.guobiao
      + '</td><td>' + power_data.province+"\n"+power_data.provincePower
      + '</td><td>' +power_data.city+"\n"+power_data.cityPower
      + '</td><td>' +power_data.area+"\n"+power_data.areaPower
      + '</td></tr>'
  ...
  var hero_data = await getdata(hero_url)
